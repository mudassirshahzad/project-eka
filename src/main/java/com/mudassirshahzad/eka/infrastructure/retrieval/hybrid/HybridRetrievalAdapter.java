package com.mudassirshahzad.eka.infrastructure.retrieval.hybrid;
...
import com.mudassirshahzad.eka.infrastructure.retrieval.hybrid.exception.HybridRetrievalException;
 ...
 * resolution is the responsibility of the {@link com.mudassirshahzad.eka.domain.retrieval.port.RankingPort}
 * (RRF), which accumulates contributions from every occurrence and emits one merged entry per
 * unique {@link com.mudassirshahzad.eka.domain.chunk.ChunkId}. This adapter does not deduplicate.
 *
 ...
 * that follows in {@link com.mudassirshahzad.eka.application.retrieval.RetrievalService}
